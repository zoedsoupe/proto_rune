defmodule Lexicon.Chat.Bsky.Convo.LogDeleteMessage do
  @moduledoc """
  Log entry for deleting a message in a conversation.

  NSID: chat.bsky.convo.defs#logDeleteMessage
  """
  ...
  @doc """
  Creates a changeset for validating a log delete message entry.
  """
  ...
  @doc """
  Validates a log delete message entry structure.
  """
