defmodule Lexicon.App.Bsky.Actor.Profile do
  ...
  embedded_schema do
    ...
    field :avatar, :map # blob
    field :banner, :map # blob
    field :labels, :map # union
    field :joined_via_starter_pack, :map # Reference to com.atproto.repo.strongRef
  ...
  def changeset(profile, attrs) do
    profile
    |> cast(attrs, [:display_name, :description, :avatar, :banner, :labels, 
                   :joined_via_starter_pack, :pinned_post, :created_at])
