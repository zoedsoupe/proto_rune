defmodule Lexicon.App.Bsky.Actor.Defs.ProfileViewDetailed do
  @moduledoc """
  Detailed profile view with complete user information.
  ...
  """
  def changeset(profile_view_detailed, attrs) do
