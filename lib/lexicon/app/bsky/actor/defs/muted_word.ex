defmodule Lexicon.App.Bsky.Actor.Defs.MutedWord do
  @moduledoc """
  ...
  defp validate_targets(changeset) do
    ...
    if targets do
      invalid_targets = Enum.filter(targets, fn target -> !Defs.valid_muted_word_target?(target) end)
  ...
  defp validate_actor_target(changeset) do
    ...
    if actor_target && !Defs.valid_muted_word_actor_target?(actor_target) do
