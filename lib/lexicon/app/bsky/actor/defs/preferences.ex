defmodule Lexicon.App.Bsky.Actor.Defs.Preferences do
  @moduledoc """
  ...
  alias Lexicon.App.Bsky.Actor.Defs.AdultContentPref
  alias Lexicon.App.Bsky.Actor.Defs.BskyAppStatePref
  alias Lexicon.App.Bsky.Actor.Defs.ContentLabelPref
  alias Lexicon.App.Bsky.Actor.Defs.FeedViewPref
  alias Lexicon.App.Bsky.Actor.Defs.HiddenPostsPref
  alias Lexicon.App.Bsky.Actor.Defs.InterestsPref
  alias Lexicon.App.Bsky.Actor.Defs.LabelersPref
  alias Lexicon.App.Bsky.Actor.Defs.MutedWordsPref
  alias Lexicon.App.Bsky.Actor.Defs.PersonalDetailsPref
  alias Lexicon.App.Bsky.Actor.Defs.PostInteractionSettingsPref
  alias Lexicon.App.Bsky.Actor.Defs.SavedFeedsPref
  alias Lexicon.App.Bsky.Actor.Defs.SavedFeedsPrefV2
  alias Lexicon.App.Bsky.Actor.Defs.ThreadViewPref
  alias Lexicon.App.Bsky.Actor.Defs.VerificationPrefs
