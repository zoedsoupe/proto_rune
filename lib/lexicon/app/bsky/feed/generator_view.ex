defmodule Lexicon.App.Bsky.Feed.GeneratorView do
  @moduledoc """
  ...
  alias Lexicon.App.Bsky.Feed, as: FeedDefs
  ...
  defp validate_content_mode(changeset) do
    ...
    if is_nil(content_mode) or FeedDefs.valid_content_mode?(content_mode) do
      changeset
    else
